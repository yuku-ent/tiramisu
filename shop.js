...
const PRODUCTS = [
  {
    ...
    description:
      "Notre baguette de tradition française, façonnée à la main et cuite sur sole de pierre. Croûte dorée et craquante, mie alvéolée et parfumée. Disponible dès 7h du matin.",
    sizes: ["Normale", "Moulée"],
    colors: null,
    stock: 200,
    featured: true,
  },
  ...
  },
  {
    ...
    sizes: ["Part individuelle", "Tarte entière (6 parts)"],
    colors: null,
    stock: 25,
    featured: true,
  },
  {
    ...
    badgeText: null,
    description:
      "Mélange de farine de blé T65 et seigle. Levain naturel, fermentation longue 24h. Croûte épaisse, mie dense et légèrement acidulée. Se conserve 3 à 4 jours.",
    sizes: ["Demi (400g)", "Entier (800g)"],
    colors: null,
    stock: 40,
    featured: true,
  },
  ...
  },
  {
    ...
    badgeText: "Nouveau",
    description:
      "Pâte à choux aérienne garnie d'une crème pâtissière au café arabica, glacée au fondant café. Un classique revisité avec des grains de café torréfiés à Paris.",
    sizes: null,
    colors: null,
    stock: 30,
    featured: false,
  ...
  },
  {
    ...
    sizes: ["Part individuelle", "Quiche entière (6 parts)"],
    colors: null,
    stock: 15,
    featured: false,
  },
  ...
  },
  {
    ...
    badgeText: "-15%",
    description:
      "Boîte de 6 macarons aux saveurs variées : framboise, pistache, caramel beurre salé, citron, chocolat et rose. Coques croustillantes, ganache fondante.",
    sizes: ["Boîte de 6", "Boîte de 12"],
    colors: null,
    stock: 35,
    featured: false,
  },
